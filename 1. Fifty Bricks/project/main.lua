...
local GROUND_SCROLL_SPEED = 120 -- originally 60
...
function love.load()
    ...
    sounds = {
        ...
        ['shieldhit'] = love.audio.newSource('shieldhit.wav', 'static')
    }

    -- kick off music
    sounds['music']:setLooping(true)
    sounds['music']:play()
    sounds['music']:seek(1.2)
...
function scroll(dt)
    if scrolling then
      backgroundScroll = (backgroundScroll + BACKGROUND_SCROLL_SPEED * dt * speedMultiplyer) % BACKGROUND_LOOPING_POINT
      groundScroll = (groundScroll + GROUND_SCROLL_SPEED * dt * speedMultiplyer) % VIRTUAL_WIDTH
    end
end
