...
function love.load()
    ...
    gSounds = {
        ...
        ['enterstreak'] = love.audio.newSource('sounds/enterstreak.wav', 'static'),
        ['exitstreak'] = love.audio.newSource('sounds/exitstreak.wav', 'static'),
        ['destroyedball'] = love.audio.newSource('sounds/destroyedball.wav', 'static'),
        ['powerup'] = love.audio.newSource('sounds/powerup.wav', 'static'),
        ['brickappears'] = love.audio.newSource('sounds/brickappears.wav', 'static'),
        ['newhighscore'] = love.audio.newSource('sounds/newhighscore.wav', 'static'),
...
function renderScore(score)
    ...
    if highscore then
      ...
      love.graphics.printf('NEW HIGHSCORE!!', 0, 5, VIRTUAL_WIDTH, 'center')
