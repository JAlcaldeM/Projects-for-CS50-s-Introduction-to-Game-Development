...
function LevelMaker.createMap(level)
    ...
    -- choose at random if this level is having a locked brick
    local locked = math.random(2)
    local lockedBricks = math.random(3)
    local lockedBricksSpawned = 0
    local centerPos = math.floor(numCols/2) + 1
    ...
    for y = 1, numRows do
        ...
        for x = 1, numCols do
            ...
            if locked == 1 and y == numRows and ((x == centerPos and (lockedBricks == 1 or lockedBricks == 3)) or (lockedBricks >=2 and (x == centerPos + 2 or x == centerPos - 2))) then
                b.color = 6
                b.tier = 1
                b.unlocked = false
                lockedBricksSpawned = lockedBricksSpawned + 1
            end
