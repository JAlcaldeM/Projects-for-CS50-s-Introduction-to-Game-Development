...
gSounds = {
    ...
    ['rowclear'] = love.audio.newSource('sounds/rowclear.wav', 'static'),
    ['bigcombo'] = love.audio.newSource('sounds/bigcombo.wav', 'static')
}

gTextures = {
    ['main'] = love.graphics.newImage('graphics/match3.png'),
    ['background'] = love.graphics.newImage('graphics/background.png'),
    ['mouse'] = love.graphics.newImage('graphics/mouse.png'),
    ['mouse2'] = love.graphics.newImage('graphics/mouse2.png'),
}
