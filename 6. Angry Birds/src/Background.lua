...
function Background:render()
    love.graphics.draw(gTextures[self.background], self.xOffset, -128*scale*camSize, 0, 1*scale*camSize, 1*scale*camSize)
    love.graphics.draw(gTextures[self.background], self.xOffset + self.width*scale*camSize, -128*scale*camSize, 0, 1*scale*camSize, 1*scale*camSize)
    love.graphics.draw(gTextures[self.background], self.xOffset - self.width*scale*camSize, -128*scale*camSize, 0, 1*scale*camSize, 1*scale*camSize)
end